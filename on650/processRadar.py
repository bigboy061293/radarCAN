...
def doLpf():
    ...
    for j in reversed(range(lpfTap-1)):
        ...
        lpf[8,j-1] = lpf[8,j]
    #print lpf[0]
    #print min_0,min_1,min_2,min_3,min_4,min_5,min_6,min_7,height_
...
def parseSec(setors):
    ...
    if abc[0] == 'E' and abc[1] == ' nomr72':
        ...
        #in8Array[6] = min(obstaclesAround[157:202])
        ...
        #if inLoiter and terrainHeight >= 120 and abs(attitudePitch) < 10 and abs(attitudeRoll) < 10 : #used for ket hop voi radar dia hinh
        if inLoiter:    
